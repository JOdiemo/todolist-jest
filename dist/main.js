...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://webpack-todo-list/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://webpack-todo-list/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://webpack-todo-list/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://webpack-todo-list/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _applications_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./applications.js */ \"./src/applications.js\");\n/* harmony import */ var _todolist_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todolist.js */ \"./src/todolist.js\");\n\r\n\r\n\r\n\r\nconst todosList = new _todolist_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\r\n(0,_applications_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(todosList);\r\n\r\n// add todo\r\nconst addBtn = document.querySelector('.add-btn');\r\naddBtn.addEventListener('click', () => {\r\n  const id = `id${Math.random().toString(10).slice(2, 4)}`;\r\n  const description = document.querySelector('.description').value.trim();\r\n  const completed = false;\r\n  const index = todosList.list.length + 1;\r\n\r\n  const newTodo = {\r\n    id, description, completed, index,\r\n  };\r\n  if (description) {\r\n    todosList.addItems(newTodo);\r\n    (0,_applications_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(todosList);\r\n  } else {\r\n    alert(\"Kindly enter a task to do.\")\r\n  }\r\n});\r\n\r\n\r\n\n\n//# sourceURL=webpack://webpack-todo-list/./src/index.js?");
